---
url: https://www.alive5.com/capturing-utm-parameters-from-web-chat-sessions
title: 
    
    Capturing UTM Parameters from Web Chat Sessions
...
status_code: 200
slug: capturing-utm-parameters-from-web-chat-sessions
---
...
This document will highlight the steps you need to obtain UTM Parameters from your web chat sessions.Thisonly applies to live (web) chat, not SMS or Facebook Messenger interactions.

If you need further assistance, help or support, please contact[support@alive5.com](mailto:support@alive5.com).

## Why Would You Need This?  ﻿

If you are focused on marketing attribution (trying to find out who or what ad campaigns are bringing you traffic) analyzing UTM Parameters ( [https://en.wikipedia.org/wiki/UTM\_parameters](https://en.wikipedia.org/wiki/UTM_parameters)) are a must.
...
https://www.example.com/page?&utm\_campaign=campaign1&utm\_medium=social&utm\_source=facebook.com&utm\_content=banner1

Then, you can go to reporting within Alive5, and download the Conversations report, and see all the captured UTM variables:

![](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/Screen+Shot+2021-07-21+at+3.12.05+PM-1920w.png)

If you have any questions, please contact us at:[support@alive5.com](mailto:support@alive5.com).

[< Older Post](https://www.alive5.com/passing-custom-variables-into-web-chat-sessions) [Newer Post >](https://www.alive5.com/doherty)
