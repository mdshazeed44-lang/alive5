---
url: https://www.alive5.com/best-practices-for-sms-opt-ins
title: 
    
    The Best Practices for SMS Opt-Ins
...
status_code: 200
slug: best-practices-for-sms-opt-ins
---
...
![Two people talking at a table](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/9-1920w.png)

## 2\. Customer Texts In

When a customer sends a text to your phone number displayed on your company website, or opts to send a text message back instead of calling back from their call log is another "natural" form of opt in. The customerwants to connectwith you, and having an auto-responder to provide adouble opt-in, which is a double confirmation(first one is customer texting in, the second confirmation is the automated reply asking them again) is the best form of opt in.

## 3\. Text Call to Action

You can prompt users to text in and start an opt in process. This would require an automated bot flow set up with akeywordto receive the inbound request and responding with a double opt-in confirmation (or reply STOP to opt out).
...
![sample NBA poster with call to actions for SMS opt-in](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/10-1920w.png)

![wedding card call to action for SMS opt-in](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/Screenshot+2022-12-08+at+8.02.02+PM-1920w.png)
...
![live example of Alive5 Opt-in Form](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/Screen+Shot+2022-12-06+at+3.20.14+PM-1920w.png)

Live Example:[Alive5 Opt-in Form](https://go.alive5.com/sms/sms-form.html?org_name=alive5demo)
...
![QR code with call to action to see phone demo with sms opt-in option](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/qr-banner-1920w.png)
...
![waitlist form with multiple call to actions for opt-in via QR and SMS](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/Flash+Sale+Creative+Banner+Design+Template.+Sale+up+to+50-.+Special+Discount+Offer+Poster.+%282%29-1920w.png)
...
![Stack of papers consisting of contracts](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/8-1920w.png)
...
- Never text out first to obtain permission.
...
Alive5 can help implement any of the use cases above, please contact us at[contact@alive5.com](mailto:contact@alive5.com)or text us at 855-551-8858 for help!

[< Older Post](https://www.alive5.com/7-concepts-that-will-make-you-an-expert-in-chatbot-marketing) [Newer Post >](https://www.alive5.com/texting-for-health-and-wellness)
