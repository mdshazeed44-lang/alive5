---
url: https://www.alive5.com/4-steps-needed-for-10dlc-compliance
title: 
...
status_code: 200
slug: 4-steps-needed-for-10dlc-compliance
---
...
To avoid delays, be prepared to take on the necessary tasks such as contacting your web developer or legal team.

Related:[10DLC and What it Means for Business SMS/Texting](https://www.alive5.com/10dlc-and-what-it-means-for-texting)
...
- Must have Privacy Policy and Opt-In Language disclaimers. These can be in About sections or pinned posts. See example:[https://www.facebook.com/wearealive5/about\_privacy\_and\_legal\_info](https://www.facebook.com/wearealive5/about_privacy_and_legal_info)
...
![](https://lirp.cdn-website.com/519d3ac1/dms3rep/multi/opt/Screenshot+2023-08-27+at+4.57.23+PM-1920w.png)

Even if you do not text your clients via the contact form (you may have a separate paper intake form to ask for texting permission), opt-in language is still required in your web forms.

This is the primary method enforced by DCAs (Direct Connect Aggregators) to check for opt-in compliance.

### 4\. Privacy Policy Compliance

To be approved for A2P (application to peer) SMS texting, 10DLC requires certain types of organizations and use cases to have a compliant Privacy Policy.

﻿For more details, visit[Privacy Policy Compliance for 10DLC](https://www.alive5.com/10dlc-and-privacy-policy-compliance).

Adhering to the recommendations above should give you the most efficient path towards 10DLC Compliance.

The 10DLC industry and requirements seem to change on aweeklybasis, so we'll be making constant updates to this page with the most up to date information to ensure your success.

[< Older Post](https://www.alive5.com/10dlc-and-what-it-means-for-texting) [Newer Post >](https://www.alive5.com/10dlc-and-privacy-policy-compliance)
